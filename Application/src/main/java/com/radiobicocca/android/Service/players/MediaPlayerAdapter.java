...
package com.radiobicocca.android.Service.players;
...
import com.radiobicocca.android.Service.PlaybackInfoListener;
import com.radiobicocca.android.Service.PlayerAdapter;
import com.radiobicocca.android.Service.contentcatalogs.MusicLibrary;
import com.radiobicocca.android.ui.MainActivity;
...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    public void playFromMedia(MediaMetadataCompat metadata) {
        Log.d("MEDIA PLAYER", "play from media");
    ...
    private void playFile(String filename) {
        ...
        try {
            Log.d("MEDIA PLAYER", "SETTING URL");
            mMediaPlayer.setDataSource("http://nr6.newradio.it:9445/stream");
        } catch (Exception e) {
            throw new RuntimeException("Failed to open file: " + mFilename, e);
        }

        try {
            Log.d("MEDIA PLAYER", "prepare media player");
            mMediaPlayer.prepare();
        } catch (Exception e) {
            Bundle params = new Bundle();
            params.putString("text", e.getLocalizedMessage());
            params.putString("full_text", e.getMessage());
    ...
    public void update(MediaMetadataCompat currentMedia){
    ...
    protected void onPlay() {
        if (mMediaPlayer != null && !mMediaPlayer.isPlaying()) {
            Log.d("MEDIA PLAYER", "play from player");
            mMediaPlayer.start();
            setNewState(PlaybackStateCompat.STATE_PLAYING);
            Log.d("MEDIA PLAYER", "state playing");
        }
    }
     ...
     * radiobicocca, if you don't want ACTION_STOP to be handled by the MediaSession, then don't
